...
export const evento = [
    ...
    { id: 7, name: "Fuente Lavamanos", tipo: "evento", categoria: "Fuentes" ,images: fuenteLavamanos,tamañoImagen:"g"},
...
export const construccion = [
    { id: 13, name: "Mobile Vigilancia", tipo: "construccion", categoria: "Casetas" ,images:casetaVigilancia,tamañoImagen:"c"},
    ...
    { id: 20, name: "Fosas Portatil", tipo: "construccion", categoria: "Fosas portatiles" ,images: fosasPortatiles,tamañoImagen:"g"},
    { id: 21, name: "Contenedor Portatil 8x20", tipo: "construccion", categoria: "Contenedores" ,images:contenedorProducto,tamañoImagen:"g"},
    ...
    { id: 28, name: "Fuente Lavamanos", tipo: "construccion", categoria: "Fuentes" ,images: fuenteLavamanos,tamañoImagen:"g"},
    ...
    { id: 33, name: "Port a Cool", tipo: "construccion", categoria: "Port a cool" ,images:portacool,tamañoImagen:"g"},
]

export const servicio = [
    { id: 34, name: "Desague de fosas septicas", tipo: "servicio", categoria: "Desague de fosas" ,images: camionDesague,tamañoImagen:"g"},
    ...
    { id: 37, name: "Inspeccion de tuberia con camara", tipo: "servicio", categoria: "Inspeccion de tuberias" ,images: camaraInspeccion,tamañoImagen:"g"}
]
